...
## a [b]heading in Restructured Text[/b] syntax describing a class stored
## in a [ClassDocDB].[br]
## The format of the output generated by the
## [method RSTClassHeadingBuilder.build] method is as follows:
## [codeblock lang=rst]
## 
## .. _godocs_Class:
## 
...
## of this class, the [RSTClassHeadingBuilder].
